...
public class UserValidator {
    ...
    private void validatePassword(String password) {
        ...
        if(!constainsSpecialChacter(password)){
    ...
    private boolean constainsSpecialChacter(String password){
        if(password == null || password.trim().isEmpty()){
            return false;
        }
        //black list - ce nu are voie sa treaca
        //white list - ce are voie sa treaca
        Pattern specialCharactersPattern = Pattern.compile("[^A-Za-z0-9]"); //black list
